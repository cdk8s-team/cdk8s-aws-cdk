...
| <code><a href="#cdk8s-aws-cdk.AwsCdkAdapater.with">with</a></code> | Applies one or more mixins to this construct. |
...
##### `with` <a name="with" id="cdk8s-aws-cdk.AwsCdkAdapater.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="cdk8s-aws-cdk.AwsCdkAdapater.with.parameter.mixins"></a>
...
| <code><a href="#cdk8s-aws-cdk.Chart.with">with</a></code> | Applies one or more mixins to this construct. |
...
##### `with` <a name="with" id="cdk8s-aws-cdk.Chart.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="cdk8s-aws-cdk.Chart.with.parameter.mixins"></a>
